...
public final class TrainerLimitTests {

    private TrainerLimitTests() {}
    ...
    public static void register(NVTestRegistrar r) {
        r.add("trainer/level_zero_costs_zero_exp", 60, helper -> {
        ...
        r.add("trainer/zero_limit_blocks_training", 60, helper -> {
            Holder<SentientUpgrade> upgrade = anyUpgrade(helper);
        ...
        r.add("trainer/deny_blocks_unlisted", 60, helper -> {
            Holder<SentientUpgrade> upgrade = anyUpgrade(helper);
        ...
        r.add("trainer/gui_deny_toggle_saves", 60, helper -> {
            Holder<SentientUpgrade> upgrade = anyUpgrade(helper);
            Player player = helper.makeMockPlayer(GameType.SURVIVAL);
