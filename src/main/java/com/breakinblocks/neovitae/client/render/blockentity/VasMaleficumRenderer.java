...
public class VasMaleficumRenderer implements BlockEntityRenderer<VasMaleficumBlockEntity, VasMaleficumRenderer.State> {
    ...
    @Override
    public void extractRenderState(VasMaleficumBlockEntity vas, State s, float partialTick, Vec3 cameraPos,
                                   ModelFeatureRenderer.@Nullable CrumblingOverlay crumbling) {
        BlockEntityRenderer.super.extractRenderState(vas, s, partialTick, cameraPos, crumbling);
