...
public class RitualCrystallumFracturaEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("To turn this ritual into a Spiritus farm:"
                + "\n\n1. Burn Spiritus in a [#](8B0000)Spiritus Crucible[#]() within range to seed the chunk."
                ...
                + "\n\n[#](2E8B57)Each Spiritus Crucible-burned crystal yielded only 5 net Spiritus by hand; with the +25%% injection bonus and 2x growth, the same crystals net you considerably more per cycle.[#]()");
