...
public class SentientHelper {
    ...
    private static void applyExpChange(ExpContext context, ExpResult result) {
        ...
        if (result.leveledUp) {
            ...
            context.wearer.sendOverlayMessage(Component.translatable("chat.neovitae.sentient_upgrade.level_up", Component.translatable(SentientUpgrade.descriptionId(context.upgrade.getKey())), result.newLevel));
        }
    }
