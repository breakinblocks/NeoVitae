...
public class AltarCategory extends CategoryProvider {
    ...
    protected void generateEntries() {
        ...
        soulNetwork.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        slates.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        redstone.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        selfSacrifice.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        sacrifice.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        orbRune.withCondition(BookEntryReadConditionModel.create().withEntry("altar/soul_network"));
        ...
        speed.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        acceleration.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        charging.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        dislocation.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        capacity.withCondition(BookEntryReadConditionModel.create().withEntry("altar/blood_altar"));
        ...
        augCapacity.withCondition(BookEntryReadConditionModel.create().withEntry("altar/rune_capacity"));
