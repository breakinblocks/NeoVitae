...
public class NVBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(NVTags.Blocks.STORAGE_BLOCKS_RAW_HELLFORGED)
                .add(NVBlocks.RAW_DEMONITE_BLOCK.block().get());
        this.tag(NVTags.Blocks.STORAGE_BLOCKS_RAW)
                .addTag(NVTags.Blocks.STORAGE_BLOCKS_RAW_HELLFORGED);
        this.tag(Tags.Blocks.STORAGE_BLOCKS)
                .addTag(NVTags.Blocks.STORAGE_BLOCKS_RAW);
        ...
        this.tag(NVTags.Blocks.ORES_HELLFORGED)
                .add(DungeonBlocks.DUNGEON_ORE.block().get());
        this.tag(Tags.Blocks.ORES)
                .addTag(NVTags.Blocks.ORES_HELLFORGED);
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(NVBlocks.ORB_FILLING_LINK.block().get())
                ...
                .add(NVBlocks.TENEBRAE_RITUAL_STONE.block().get())
                .add(NVBlocks.DEUS_RITUAL_STONE.block().get())
                ...
                .add(NVBlocks.OMNI_ROUTING_NODE.block().get())
