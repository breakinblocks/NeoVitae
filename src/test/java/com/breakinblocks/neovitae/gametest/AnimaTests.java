...
public final class AnimaTests {
    ...
    public static void register(NVTestRegistrar r) {
        r.add("anima/creates_for_uuid", 30, helper -> {
        ...
        r.add("anima/add_and_syphon", 30, helper -> {
            helper.runAfterDelay(1, () -> {
                Anima anima = getOrCreateNetwork();
        ...
        r.add("anima/cannot_over_syphon", 30, helper -> {
            helper.runAfterDelay(1, () -> {
                Anima anima = getOrCreateNetwork();
        ...
        r.add("anima/altar_fills_bound_orb", 300, helper -> {
            ...
            helper.runAfterDelay(5, () -> {
                ...
                helper.succeedWhen(() -> {
                    ...
                    helper.assertTrue(lpAfter > lpBefore,
                            "Orb filling should add EV to anima (before=" + lpBefore + " after=" + lpAfter + ")");
                });
            });
        });

        r.add("anima/alchemy_table_crafts_with_bound_orb", 100, helper -> {
            BlockPos pos = new BlockPos(3, 1, 2);
            helper.setBlock(new BlockPos(3, 0, 2), Blocks.STONE.defaultBlockState());
        ...
        r.add("anima/alchemy_table_syphons_lp", 100, helper -> {
            BlockPos pos = new BlockPos(3, 1, 2);
            helper.setBlock(new BlockPos(3, 0, 2), Blocks.STONE.defaultBlockState());
            helper.setBlock(pos, NVBlocks.TABULA_VITAE.block().get().defaultBlockState());
            TabulaVitaeBlockEntity table = helper.getBlockEntity(pos, TabulaVitaeBlockEntity.class);
