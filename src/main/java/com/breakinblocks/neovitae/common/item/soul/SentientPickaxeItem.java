...
public class SentientPickaxeItem extends Item implements ISentientTool {
    ...
    public SentientPickaxeItem(Item.Properties props) {
        super(props.pickaxe(NVMaterialsAndTiers.SENTIENT, 1, -2.8f)
