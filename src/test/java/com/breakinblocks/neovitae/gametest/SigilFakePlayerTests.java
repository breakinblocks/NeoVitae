...
public final class SigilFakePlayerTests {

    private SigilFakePlayerTests() {}
    ...
    public static void register(NVTestRegistrar r) {
        r.add("sigil/fake_player_spends_owner_ev_then_stops", 40, helper -> {
        ...
        r.add("sigil/real_player_still_pays_with_health", 40, helper -> {
        ...
        r.add("sigil/binding_refuses_fake_player", 40, helper -> {
            FakePlayer fake = fakePlayer(helper);
        ...
        r.add("sigil/existing_fake_binding_is_revoked", 40, helper -> {
            FakePlayer fake = fakePlayer(helper);
            SigilItem sigil = NVItems.SIGIL_LAVA.get();
            ItemStack stack = new ItemStack(sigil);
        ...
        r.add("sigil/owner_binding_survives_fake_player_holding", 40, helper -> {
            FakePlayer fake = fakePlayer(helper);
            SigilItem sigil = NVItems.SIGIL_LAVA.get();
            ItemStack stack = new ItemStack(sigil);
            UUID owner = UUID.randomUUID();
