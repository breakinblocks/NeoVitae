...
public class NVBlocks {
    ...
    public static final BlockWithItemHolder<BlockRitualStone, BlockItem> DUSK_RITUAL_STONE = BLOCK_REG.register("dusk_ritual_stone", props -> new BlockRitualStone(props, EnumRuneType.DUSK), defaultBlockProps());
    public static final BlockWithItemHolder<BlockRitualStone, BlockItem> DAWN_RITUAL_STONE = BLOCK_REG.register("dawn_ritual_stone", props -> new BlockRitualStone(props, EnumRuneType.DAWN), defaultBlockProps());
