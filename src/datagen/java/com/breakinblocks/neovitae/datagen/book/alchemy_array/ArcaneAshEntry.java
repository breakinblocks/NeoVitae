...
public class ArcaneAshEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.page("arrays", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("The arrays catalogd in this chapter range from simple [#](8B0000)crafting arrays[#]() that reshape "
                + "matter, to complex inscriptions that forge [#](4A0080)sigils[#](), bind [#](4A0080)sentient armor[#](), "
