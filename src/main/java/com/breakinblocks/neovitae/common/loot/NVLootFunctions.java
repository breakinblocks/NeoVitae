...
public class NVLootFunctions {
    ...
    public static final DeferredHolder<MapCodec<? extends LootItemFunction>, MapCodec<SetSentientUpgrade>> SET_LIVING_UPGRADE =
            LOOT_FUNCTIONS.register("set_living_upgrade", () -> SetSentientUpgrade.CODEC);
