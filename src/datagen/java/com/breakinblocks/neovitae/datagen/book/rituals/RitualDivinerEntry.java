...
public class RitualDivinerEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.page("direction", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("You can also change the direction that the completed ritual will face by pressing Use. This will only affect a small number of rituals, such as the **Ritual of Speed**, as most rituals are symmetrical.");

        this.page("crafting", () -> BookCraftingRecipePageModel.create()
                .withRecipeId1(ResourceLocation.fromNamespaceAndPath(NeoVitae.MODID, "ritual_diviner_0"))
                .withText(this.context().pageText()));
        this.pageText("Simply tap Use while looking at a **Master Ritual Stone** to make the Diviner build the currently selected ritual out of any **Ritual Stones** you may be carrying. It's almost like magic!");
