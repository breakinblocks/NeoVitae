...
public class AlchemyTableCategory extends CategoryProvider {
    ...
    protected void generateEntries() {
        ...
        anointments.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/alchemy_table"));
        ...
        potions.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/alchemy_table"));
        ...
        melee.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        fortune.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        looting.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        holyWater.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        hiddenKnowledge.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        silkTouch.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        smelting.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        voiding.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        weaponRepair.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        bowPower.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        bowVelocity.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        quickDraw.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/anointments"));
        ...
        speed.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        strength.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        regen.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        health.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        poison.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        weakness.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        bounce.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        hardCloak.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        passive.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        nightVision.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        fireResistance.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        waterBreathing.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        jumpBoost.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        slowFalling.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/potion_crafting"));
        ...
        slowness.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_speed"));
        ...
        damage.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_instant_health"));
        ...
        invisibility.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_night_vision"));
        ...
        spectralSight.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_night_vision"));
        ...
        levitation.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_slow_falling"));
        ...
        grounded.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_jump_boost"));
        ...
        gravity.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_grounded"));
        ...
        obsidianCloak.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_hard_cloak"));
        ...
        suspended.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_gravity"));
        ...
        heavyHeart.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_gravity"));
        ...
        flight.withCondition(BookEntryReadConditionModel.create().withEntry("neovitae:alchemy_table/flask_suspended"));
