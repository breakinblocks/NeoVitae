...
public final class PlacerTests {
    ...
    private static void chestOf(GameTestHelper helper, BlockPos relPos, ItemStack contents) {
        ...
        ChestBlockEntity chest = helper.getBlockEntity(relPos, ChestBlockEntity.class);
        if (chest != null) {
    ...
    private static long savedCursor(RitualPlacer ritual) {
        ...
        return tag.getLongOr("fillCursor", -1L);
    }
    ...
    public static void register(NVTestRegistrar r) {
        r.add("placer/fill_modes_on_a_cube", 30, helper -> {
        ...
        r.add("placer/fill_modes_on_a_flat_slab", 30, helper -> {
        ...
        r.add("placer/floor_and_roof_are_single_layers", 30, helper -> {
            AreaCursor c = cursor(5, 5, 5);
        ...
        r.add("placer/cursor_visits_every_position_exactly_once", 30, helper -> {
        ...
        r.add("placer/cursor_matches_a_hemisphere_exactly", 30, helper -> {
        ...
        r.add("placer/skip_to_jumps_whole_layers", 30, helper -> {
        ...
        r.add("placer/skip_to_never_skips_an_accepted_position", 30, helper -> {
        ...
        r.add("placer/spiritus_tiers_match_the_published_table", 30, helper -> {
        ...
        r.add("placer/places_blocks_from_an_adjacent_chest", 120, helper -> {
        ...
        r.add("placer/floor_mode_only_fills_the_bottom_layer", 120, helper -> {
            BlockPos master = new BlockPos(3, 1, 3);
        ...
        r.add("placer/skips_blocks_that_cannot_survive", 120, helper -> {
            BlockPos master = new BlockPos(3, 1, 3);
            ...
            ChestBlockEntity chest = helper.getBlockEntity(master.above(), ChestBlockEntity.class);
            if (chest != null && chest.getItem(0).getCount() != 32) {
        ...
        r.add("placer/cursor_resumes_instead_of_restarting", 200, helper -> {
        ...
        r.add("placer/cursor_does_not_materialise_the_position_list", 30, helper -> {
