...
public final class DungeonKeyLootTests {
    ...
    private DungeonKeyLootTests() {}

    public static void register(NVTestRegistrar r) {
        r.add("dungeon_keys/entrance_cache_rolls_two_or_three_standard_keys", 100, helper -> {
        ...
        r.add("dungeon_keys/trial_spawners_outdrop_chests_for_standard_keys", 100, helper -> {
            helper.runAfterDelay(1, () -> {
