...
public class CrystalGrowthCategory implements IRecipeCategory<CrystalGrowthJEIRecipe> {
    ...
    public static final IRecipeType<CrystalGrowthJEIRecipe> RECIPE_TYPE =
            IRecipeType.create(NeoVitae.MODID, "crystal_growth", CrystalGrowthJEIRecipe.class);
    ...
    @Override
    public IRecipeType<CrystalGrowthJEIRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull CrystalGrowthJEIRecipe recipe,
        ...
        builder.addSlot(RecipeIngredientRole.CRAFTING_STATION, slot1X + 1, ROW_Y + 1)
    ...
    @Override
    public void draw(CrystalGrowthJEIRecipe recipe, IRecipeSlotsView slotsView, GuiGraphicsExtractor guiGraphics,
    ...
    private void line(GuiGraphicsExtractor guiGraphics, net.minecraft.client.gui.Font font, int index, Component text) {
        guiGraphics.text(font, text, TEXT_X, TEXT_TOP + index * LINE, 0xFF404040, false);
    }

    @Override
    public Identifier getIdentifier(CrystalGrowthJEIRecipe recipe) {
        return NeoVitae.rl("crystal_growth/" + recipe.type().getSerializedName());
    }
}
