...
public class LivingEquipmentEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("To create **Living Equipment**, you will first need **Iron Armor**, some **Arcane Ash**, "
                + "and some **Binding Reagent**. You'll also need at least a **Common Tartaric Gem** in order "
                + "to hold the **Demon Will** required.");
