...
public class RitualBasicsEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.page("building", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("Place down a Master Ritual Stone, and hold Use until all the stones have been placed and painted with the correct element. Finally, press Use on the Master Ritual Stone with your Activation Crystal in hand. If you've done everything right, you should get a message saying 'A rush of energy flows through the ritual!'. The ritual is now active.");
