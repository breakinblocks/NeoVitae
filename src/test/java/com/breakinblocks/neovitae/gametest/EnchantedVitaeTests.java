...
public final class EnchantedVitaeTests {

    private EnchantedVitaeTests() {}
    ...
    public static void register(NVTestRegistrar r) {
        r.add("enchanted_vitae/applies_every_valid_enchantment_and_leaves_books_alone", 40, helper -> {
        ...
        r.add("enchanted_vitae/skips_enchantments_the_item_cannot_take", 40, helper -> {
        ...
        r.add("enchanted_vitae/reports_an_exclusive_pair_instead_of_picking_one", 40, helper -> {
            ItemStack pickaxe = new ItemStack(Items.DIAMOND_PICKAXE);
        ...
        r.add("enchanted_vitae/reports_a_conflict_against_what_the_item_already_holds", 40, helper -> {
            ItemStack pickaxe = new ItemStack(Items.DIAMOND_PICKAXE);
        ...
        r.add("enchanted_vitae/honours_levels_beyond_the_vanilla_ceiling", 40, helper -> {
            ItemStack sword = new ItemStack(Items.DIAMOND_SWORD);
        ...
        r.add("enchanted_vitae/skips_what_the_item_already_has_at_or_above_the_offer", 40, helper -> {
            ItemStack sword = new ItemStack(Items.DIAMOND_SWORD);
            ItemEnchantments.Mutable existing = new ItemEnchantments.Mutable(ItemEnchantments.EMPTY);
        ...
        r.add("enchanted_vitae/consuming_books_only_eats_the_ones_that_contributed", 40, helper -> {
            ItemStack sword = new ItemStack(Items.DIAMOND_SWORD);
            ItemStack sharpness = book(helper, Enchantments.SHARPNESS, 5);
        ...
        r.add("enchanted_vitae/a_stack_of_books_loses_only_one", 40, helper -> {
            ItemStack sword = new ItemStack(Items.DIAMOND_SWORD);
        ...
        r.add("enchanted_vitae/cost_scales_with_level_and_rarity", 40, helper -> {
            ItemStack sword = new ItemStack(Items.DIAMOND_SWORD);
