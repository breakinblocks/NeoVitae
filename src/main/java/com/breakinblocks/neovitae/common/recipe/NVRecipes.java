...
public class NVRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<LivingDowngradeRecipe>> LIVING_DOWNGRADE_SERIALIZER = SERIALIZERS.register(LivingDowngradeRecipe.RECIPE_TYPE_NAME, () -> new RecipeSerializer<>(LivingDowngradeRecipe.CODEC, LivingDowngradeRecipe.STREAM_CODEC));
