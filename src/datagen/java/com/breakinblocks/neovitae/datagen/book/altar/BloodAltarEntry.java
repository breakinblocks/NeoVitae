...
public class BloodAltarEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("The [#](8B0000)Blood Altar[#]() is the central block of the mod, able to convert raw "
        ...
        this.page("usage", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("When placed into the world, the [#](8B0000)Blood Altar[#]() converts blood into [#](8B0000)Life Essence[#](), "
        ...
        this.pageText("The first item that you will want to craft is a [#](8B0000)Weak Blood Orb[#](), which by default "
                + "is a diamond plus [#](8B0000)2000 Life Essence[#]() inside of a Tier 1 Blood Altar. All items that can "
                + "be crafted by the Blood Altar can be found using Just Enough Items (JEI).");

        this.page("blank_rune", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("To upgrade the Blood Altar, you need to craft [#](8B0000)Blood Runes[#]() and place them around "
        ...
        this.page("tier2_text", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("In order to upgrade the Blood Altar to Tier 2, you must place 8 [#](8B0000)Blood Runes[#]() around "
        ...
        this.pageText("Now that you have a Tier 2 Altar, you can look into getting [#](8B0000)Life Essence[#]() from "
                + "somewhere other than yourself. The [#](8B0000)Dagger of Sacrifice[#]() will allow you to sacrifice any "
        ...
        this.page("tier3_text", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("To upgrade the Blood Altar to Tier 3, place 5 [#](8B0000)Blood Runes[#]() one block down and two "
        ...
        this.page("tier5_text", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("To upgrade the Blood Altar to Tier 5, place 13 [#](8B0000)Blood Runes[#]() one block down and three "
        ...
        this.page("tier6_text", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("To upgrade the Blood Altar to Tier 6, place 19 [#](8B0000)Blood Runes[#]() one block down and three "
                + "blocks away from the previous set of runes along each edge. Leave a one-block gap on either "
