    ...
    public static void bootstrap(BootstrapContext<SentientUpgrade> context) {
        ...
        context.register(
                ...
                new SentientUpgrade.Builder() // TODO 6 dias = 1 xp, 1 1xp tome netherite upgraded = 1000xp
                        ...
                        .level(3000, 70)
                        .level(4000, 85)
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(NETHERITE_PROTECT.identifier(), Attributes.ARMOR, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(1f, 3f, 4f, 5f, 5f, 5f, 5f, 5f), LevelBasedValue.constant(0f))))
                        .withEffect(SentientEffectComponents.ATTRIBUTES.get(), new AttributeEffect(NETHERITE_PROTECT.identifier(), Attributes.ARMOR_TOUGHNESS, Operation.ADD_VALUE, LevelBasedValue.lookup(List.of(2f, 4f, 6f, 8f, 9f, 10f, 11f, 12f), LevelBasedValue.constant(0f))))
                        .build()
        );
        context.register(
                DIGGING,
