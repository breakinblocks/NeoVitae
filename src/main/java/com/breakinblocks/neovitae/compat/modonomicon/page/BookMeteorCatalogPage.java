...
public class BookMeteorCatalogPage extends BookPage {
    ...
    public BookMeteorCatalogPage(BookTextHolder title, String anchor, BookCondition condition) {
        super(anchor, condition);
        this.title = title;
    }

    public static BookMeteorCatalogPage fromJson(JsonObject json, HolderLookup.Provider provider) {
        ...
        return new BookMeteorCatalogPage(title, anchor, condition);
    }

    public static BookMeteorCatalogPage fromNetwork(RegistryFriendlyByteBuf buffer) {
    ...
    public ResourceLocation getType() {
        return NVPageTypes.METEOR_CATALOG;
    }
