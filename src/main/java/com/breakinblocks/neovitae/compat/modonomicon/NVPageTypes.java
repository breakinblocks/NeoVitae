...
public class NVPageTypes {
    public static final Identifier ARA_VITAE = NeoVitae.rl("ara_vitae_recipe");
    public static final Identifier HELLFIRE_FORGE = NeoVitae.rl("hellfire_forge_recipe");
    public static final Identifier TABULA_VITAE = NeoVitae.rl("tabula_vitae_recipe");
