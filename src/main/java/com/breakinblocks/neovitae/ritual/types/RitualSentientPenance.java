...
public class RitualSentientPenance extends Ritual {
    ...
    public void performRitual(IMasterRitualStone masterRitualStone) {
        ...
        for (ItemEntity itemEntity : items) {
            ...
            Optional<RecipeHolder<SentientDowngradeRecipe>> recipe = ctx.serverLevel().recipeAccess()
                    .getRecipeFor(NVRecipes.SENTIENT_DOWNGRADE_TYPE.get(), new SentientDowngradeInput(stack), ctx.serverLevel());
            ...
            Optional<Holder.Reference<SentientUpgrade>> holder = ctx.level().registryAccess()
                    .lookupOrThrow(NVRegistries.Keys.SENTIENT_UPGRADES).get(upgradeKey);
