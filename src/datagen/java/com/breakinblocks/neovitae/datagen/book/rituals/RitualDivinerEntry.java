...
public class RitualDivinerEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.page("crafting", () -> BookCraftingRecipePageModel.create()
                ...
                .withText(this.context().pageText()));
        this.pageText("Simply tap Use while looking at a [#](8B0000)Master Ritual Stone[#]() to make the Diviner build the currently selected ritual out of any [#](8B0000)Ritual Stones[#]() you may be carrying. It's almost like magic!");
