...
public class BookAltarTierInfoPage extends BookPage {
    ...
    public BookAltarTierInfoPage(BookTextHolder title, String anchor, BookCondition condition) {
        super(anchor, condition);
        this.title = title;
    }

    public static BookAltarTierInfoPage fromJson(JsonObject json, HolderLookup.Provider provider) {
        ...
        return new BookAltarTierInfoPage(title, anchor, condition);
    }

    public static BookAltarTierInfoPage fromNetwork(RegistryFriendlyByteBuf buffer) {
    ...
    public ResourceLocation getType() {
        return NVPageTypes.ALTAR_TIER_INFO;
    }
