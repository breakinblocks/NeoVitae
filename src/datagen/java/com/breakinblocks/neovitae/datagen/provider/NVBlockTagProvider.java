...
public class NVBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(NVTags.Blocks.T4_CAPSTONES)
                .add(NVBlocks.BLOODSTONE_BRICK.block().getKey());
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(NVBlocks.TENEBRAE_RITUAL_STONE.block().getKey())
                .add(NVBlocks.DEUS_RITUAL_STONE.block().getKey())
                ...
                .add(NVBlocks.SPIRIT_ACCUMULATOR.block().getKey())
