...
public class RoutingNodesEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("Routing Nodes move more than items; they transfer [#](8B0000)fluids[#]() and [#](8B0000)Forge Energy[#]() "
                ...
                + "gated by the [#](8B0000)Enable[#]() flag; it has no whitelist or blacklist of its own. The "
                + "[#](8B0000)Energy[#]() tab holds a single [#](8B0000)On / Off[#]() switch for the chosen face, "
                + "and it stands On until you say otherwise. Silence it there when a face should carry only "
                + "items or fluids.");
