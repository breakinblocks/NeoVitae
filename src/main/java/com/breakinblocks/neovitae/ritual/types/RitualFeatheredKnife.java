...
// SPDX-FileCopyrightText: 2020-2024 WayofTime <https://github.com/WayofTime>
        ...
        for (Player player : players) {
            ...
            if (hasCorrosive && (will.getCorrosive() - corrosiveUsed) >= CORROSIVE_WILL_PER_USE) {
                ...
                if (incense > 0) {
                    ...
                    if (damage > 0) {
                        player.hurtServer((ServerLevel) player.level(), ctx.level().damageSources().source(NVDamageSources.SELF_SACRIFICE), damage);
