...
public class NVRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<AnointmentApplyRecipe>> ANOINTMENT_APPLY_SERIALIZER = SERIALIZERS.register("anointment_apply", () -> new NVRecipeSerializer<>(AnointmentApplyRecipe.CODEC, AnointmentApplyRecipe.STREAM_CODEC));
