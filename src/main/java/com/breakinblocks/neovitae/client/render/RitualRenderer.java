...
public class RitualRenderer {
    ...
    private static final Identifier RITUAL_STONE_DEUS = NeoVitae.rl("block/deus_ritual_stone");
    private static final Identifier RITUAL_STONE_TENEBRAE = NeoVitae.rl("block/tenebrae_ritual_stone");
