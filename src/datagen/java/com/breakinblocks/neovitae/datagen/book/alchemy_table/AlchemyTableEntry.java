...
public class AlchemyTableEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("The [#](8B0000)Alchemy Table[#]() crafts items using [#](8B0000)LP[#]() from a [#](8B0000)Soul Network[#](). "
                ...
                + "The [#](8B0000)Alchemy Table[#]() is used to craft a handful of [#](8B0000)Neo Vitae[#]() components, "
        ...
        this.page("crafting", () -> BookCraftingRecipePageModel.create()
                ...
                .withText(this.context().pageText()));
        this.pageText("When looking at [#](8B0000)Alchemy Table[#]() recipes in this book (or in [#](8B0000)JEI[#]()), "
        ...
        this.pageText("The [#](8B0000)Alchemy Table[#]() has a number of buttons on its right hand side. "
                ...
                + "six buttons to toggle whether or not the [#](8B0000)Alchemy Table[#]() should allow [#](8B0000)Hoppers[#](), pipes, "
        ...
        this.page("sigil_recipes", () -> BookTextPageModel.create()
                .withText(this.context().pageText()));
        this.pageText("The [#](8B0000)Lava Sigil[#]() and [#](8B0000)Water Sigil[#]() can be used in the Alchemy Table to produce "
