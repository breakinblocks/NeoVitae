...
public class RitualDivinerMenu extends AbstractContainerMenu {
    ...
    public RitualDivinerMenu(int containerId, Inventory playerInv, FriendlyByteBuf buf) {
        ...
        this.ritualIds = buf.readList(b -> ResourceLocation.parse(b.readUtf()));
    }

    public RitualDivinerMenu(int containerId, Inventory playerInv, InteractionHand hand, List<ResourceLocation> ritualIds) {
        super(NVMenus.RITUAL_DIVINER.get(), containerId);
        this.hand = hand;
    ...
    public List<ResourceLocation> getRitualIds() {
        return ritualIds;
    }
    ...
    public boolean clickMenuButton(Player player, int id) {
        ...
        ResourceLocation ritualId = ritualIds.get(id);
