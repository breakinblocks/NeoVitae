...
public class AlchemicalReactionChamberEntry extends EntryProvider {

    public AlchemicalReactionChamberEntry(CategoryProviderBase parent) {
        super(parent);
    }
    ...
    protected void generatePages() {
        ...
        this.pageText("The [#](8B0000)Alchemical Reaction Chamber[#](), or ARC for short, can function as a Furnace, "
        ...
        this.page("arc_recipes", () -> BookTextPageModel.create()
                .withTitle(this.context().pageTitle())
                .withText(this.context().pageText()));
        this.pageTitle("ARC Recipes");
        this.pageText("The ARC can produce Weak Blood Shards from Saturated Tau, and revert various items:\n"
                + "- Weak Blood Orb\n"
        ...
        this.pageText("All Reinforced Runes can be reverted in the ARC with a Sanguine Reverter. "
        ...
        this.pageText("Should you wish to automate the ARC, perhaps as part of an Ore-Tripling chain, "
    ...
    protected String entryName() {
        return "Alchemical Reaction Chamber";
    }

    @Override
    protected String entryDescription() {
        return "The ARC: furnace, ore tripler, and item reverter.";
    }
    ...
    protected BookIconModel entryIcon() {
        return BookIconModel.create(NVBlocks.ARC_BLOCK.asItem());
    }

    @Override
    protected String entryId() {
        return "alchemical_reaction_chamber";
    }
}
