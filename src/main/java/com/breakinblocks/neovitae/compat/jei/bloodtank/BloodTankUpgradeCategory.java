...
public class BloodTankUpgradeCategory implements IRecipeCategory<BloodTankUpgradeJEIRecipe> {
    public static final IRecipeType<BloodTankUpgradeJEIRecipe> RECIPE_TYPE =
            IRecipeType.create(NeoVitae.MODID, "blood_tank_upgrade", BloodTankUpgradeJEIRecipe.class);
    ...
    @Override public IRecipeType<BloodTankUpgradeJEIRecipe> getRecipeType() { return RECIPE_TYPE; }
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull BloodTankUpgradeJEIRecipe recipe, @Nonnull IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, OUTPUT_X + 1, cellY(1) + 1).add(recipe.outputTank());
    }

    private void addInput(IRecipeLayoutBuilder builder, int col, int row, ItemStack stack) {
        builder.addSlot(RecipeIngredientRole.INPUT, cellX(col) + 1, cellY(row) + 1).add(stack);
    }

    @Override
    public void draw(BloodTankUpgradeJEIRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public Identifier getIdentifier(BloodTankUpgradeJEIRecipe recipe) {
