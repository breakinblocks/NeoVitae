...
public class LifeEssenceBucketEntry extends EntryProvider {
    ...
    protected void generatePages() {
        ...
        this.pageText("[#](8B0000)Life Essence[#]() is all fine and good in the Ara Vitae, where it can be used for crafting "
                ...
                + "place a Bucket in the Ara Vitae and wait a few seconds for it to fill up. 1 LP = 1mb, "
                + "so 1,000 LP should be plenty for your Bucket.");

        this.page("recipe", () -> BookTextPageModel.create()
                .withTitle(this.context().pageTitle())
                .withText(this.context().pageText()));
        this.pageTitle("Ara Vitae Recipe");
        this.pageText("Place a Bucket in the Ara Vitae with at least 1,000 LP to receive a Bucket of Life Essence.\\\n\\\n"
    ...
    protected String entryDescription() {
        return "Extracting Life Essence from the Ara Vitae.";
    }
