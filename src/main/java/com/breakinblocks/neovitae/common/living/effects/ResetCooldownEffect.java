...
public record ResetCooldownEffect(Identifier id, LevelBasedValue amounts, Optional<LivingEntityEffect> effect) implements LivingEntityEffect {
    ...
    public void apply(int upgradeLevel, Entity entity) {
        Map<Identifier, Double> data = entity.getData(NVDataAttachments.LIVING_ADDITIONAL);
