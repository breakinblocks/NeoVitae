...
> *The veil between worlds is thinner than scholars like to admit. Cut deeply enough, and you can step through.*

The **Demon Realm** is a dimension unto itself, registered as `neovitae:dungeon` and reached only through bloodletting. Once across the threshold, you find yourself wandering corridors of pale-blue [Demon Stone](Dungeon-Mechanics), past sealed doors, hostile [Daemonium](Daemonium-Bestiary), and treasures that no surface mason ever built a chest for.

This page is the road map. For what to fight, see [Daemonium Bestiary](Daemonium-Bestiary). For the traps, blocks, and crops you will encounter, see [Dungeon Mechanics](Dungeon-Mechanics).

## Reaching the Realm

Two [rituals](Rituals) puncture the veil, and they correspond to two distinct depths of the dungeon.
...
The Tier III ritual skips the vestibule and drops you directly into the **Endless Realm**, the heart of the dimension. The air is thicker here, the shadows deeper, and the chambers are far more dangerous. You emerge before an Inversion Pillar with a lone chest left by some prior explorer who, judging by the chest still being there, did not leave by choice.

The realm generates as a procedural **jigsaw** structure: hand-authored NBT rooms stitched together along a graph of corridors, with sealed seal-doors at every junction. Every visit is laid out differently, but the underlying rooms are the same set of curated pieces, so you learn the building blocks even as the maps shuffle. As you explore deeper, **tile difficulty escalates**; the rooms further from the entry pillar carry tougher [trial spawners](Daemonium-Bestiary) and richer loot.

### Two Warnings, Two Milestones

The realm itself narrates your progress through dungeon-wide messages, so pay attention.

After enough rooms have been cleared, you receive the first warning:
...
Once every sealed doorway in the dungeon has been opened or collapsed, a **Spatial Rift** tears open near the exit portal. Dark blood-tendrils radiate from the fracture. Step into it and you are transported to a **brand new Endless Realm**, freshly generated, with its own keys to find and its own Foreman to kill. A return portal in the new dungeon leads back to the previous one; the standard Inversion Pillar always takes you home.

This loop is **infinite**. Each rift leads deeper.

## Dungeon Keys

All keys, whether crafted or found, are listed below. See [Hellfire Forge and Sentient Equipment](Hellfire-Forge-and-Sentient-Equipment) for crafting.
...
Set into the walls of the Endless Realm and gleaming with a pale, unwavering light, **Dungeon Eyes** illuminate the corridors with no fuel or flame. Whether they are sentinels or mere decoration is unclear; what is certain is that they are valid light sources you can claim and place yourself.

Variants exist tinted by **Raw**, **Ruina**, **Nihilum**, **Invictus**, and **Vindicta** [Spiritus](Spiritus-Aspects-and-Crystals). Consult JEI for crafting recipes.

## Rare Spoils: Intricate Hellforged Parts

Delve deep enough and fortune may yield **Intricate Hellforged Parts**. These rare components **double the potency** of an existing rune, effectively giving you the runic output of two Ara Vitaes from a single structure. They are among the most coveted drops the realm offers, and they cannot be crafted; only found.
...
Cross the threshold once. You will come back. The realm has a way of keeping its guests interested.
